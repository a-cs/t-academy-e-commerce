search12RandomProducts()

function search12RandomProducts() {
	let randomIndex = []
	while (randomIndex.length < 12) {
	...
	let randomProducts = []
	randomIndex.forEach(number => {
		randomProducts.push(products[number])
	})
	...
	document.getElementById("tableBody12Products").innerHTML = text
	document.getElementById("total12Products").innerHTML = randomProducts.length
}